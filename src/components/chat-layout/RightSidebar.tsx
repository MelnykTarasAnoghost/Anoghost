...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  const leaveRoomOnUnload = () => {
    navigator.sendBeacon(
      "/api/leaveRoom",
      JSON.stringify({ roomId: roomData.roomId })
    );
  };

  useEffect(() => {
    window.addEventListener("unload", leaveRoomOnUnload);
    return () => {
      window.removeEventListener("unload", leaveRoomOnUnload);
    };
  }, [roomData.roomId]);
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-[#1a1a1a]">
        <button
          ...
          className="w-full bg-red-500 text-white font-medium py-3 rounded-lg flex items-center justify-center hover:bg-red-600 transition-colors"
        >
            ...
            {roomData.isPrivate ? (
                ...
                {currentStep === 1 ? (
                  <div className="space-y-4">
                    <p className="text-gray-300 mb-3">
                      Add GhostIDs to grant access to this
                      private room. Each GhostID will receive an NFT access
                      pass.
                    </p>
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        Each GhostID will receive an NFT
                        access pass to this chat room
                      </p>
                    </div>
              ...
              <div className="space-y-4">
                <p className="text-gray-300 mb-4">
                  This is a public room. Share the Room ID
                ...
                <div className="border border-[#222222] rounded-xl p-4">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Anyone with this Room ID can request to
                    join this chat room
                  </p>
                </div>
