      ...
      >
        ...
        <div className="flex justify-between items-center p-6 border-b border-[#333333]">
          <div className="flex items-center">
            <button
              onClick={onClose}
              className="w-9 h-9 rounded-full bg-[#111111] flex items-center justify-center text-gray-400 hover:text-white transition-colors border border-[#222222] hover:border-[#FF4D00] hover:text-[#FF4D00] mr-4"
            >
              <ArrowLeft size={18} />
            </button>
