...
const ChatRoomForm: React.FC<ChatRoomFormProps> = ({
  ...
  useEffect(() => {
    // This effect ensures the nickname is set as soon as a user registers.
    // Since the backend no longer returns a nickname with "registerUser", this is now handled by the form itself.
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="mt-auto">
        <button
          ...
          disabled={isLoading || isGhostIdLoading}
        >
          Next Step
